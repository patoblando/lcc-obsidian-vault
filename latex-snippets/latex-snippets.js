export default [
  ...
  {trigger: "qed", replacement: "$$\n\\tag*{$\\square$}\n$$$0", options: "tAw"},
	...
	{trigger: "(?<!\\\\)sq\\b", replacement: "\\sqrt{ $0 }$1", options: "mAr"},
    ...
    {trigger: "annh", replacement: "^{\\circ}$0", options: "mA"},
    {trigger: "dual", replacement: "^{*}$0", options: "mA"},
	...
	{trigger: "@P", replacement: "\\mathscr{P}", options: "mA"},// P cursiva
    {trigger: "mathbb", replacement: "\\mathbb{$0}", options: "mA"},
    ...
    {trigger: "Lfp", replacement: "L(f,P)$0", options: "mA"},
    {trigger: "lfp", replacement: "L(f,P)$0", options: "mA"},
    {trigger: "ufp", replacement: "U(f,P)$0", options: "mA"},
    {trigger: "Ufp", replacement: "U(f,P)$0", options: "mA"},
    {trigger: "par", replacement: "\\frac{ \\partial ${0:y} }{ \\partial ${1:x} } $2", options: "m"},
    {trigger: /pa([A-Za-z])([A-Za-z])/, replacement: "\\frac{ \\partial [[0]] }{ \\partial [[1]] } ", options: "rm"},
    {trigger: "ddt", replacement: "\\frac{d}{dt} ", options: "mA"},
    {trigger: "ndt", replacement: "^{(n)}$0", options: "mA"},
    {trigger: "kdt", replacement: "^{(k)}$0", options: "mA"},

    {trigger: /([^\\])int/, replacement: "[[0]]\\int", options: "mA", priority: -1},
    {trigger: "\\int", replacement: "\\int $0 \\, d${1:x} $2", options: "m"},
    {trigger: "dint", replacement: "\\int_{${0:a}}^{${1:b}} $2 \\, d${3:x} $4", options: "mA"},
    {trigger: "lint", replacement: "\\underline{\\int}_{${0:a}}^{${1:b}} $2 \\, $3", options: "mA"},
    {trigger: "uint", replacement: "\\overline{\\int}_{${0:a}}^{${1:b}} $2 \\, $3", options: "mA"},
    {trigger: "oint", replacement: "\\oint", options: "mA"},
	{trigger: "iint", replacement: "\\iint", options: "mA"},
    {trigger: "iiint", replacement: "\\iiint", options: "mA"},
    {trigger: "oinf", replacement: "\\int_{0}^{\\infty} $0 \\, d${1:x} $2", options: "mA"},
	{trigger: "iinfi", replacement: "\\int_{-\\infty}^{\\infty} $0 \\, d${1:x} $2", options: "mA"},



	// Infimum and supremum
	{trigger: "inf{", replacement: "\\inf \\{$0\\}$1", options: "mA"},
	{trigger: "sup{", replacement: "\\sup \\{$0\\}$1", options: "mA"},
	{trigger: "sup_", replacement: "\\sup_{$0}$1", options: "mA"},
	{trigger: "inf_", replacement: "\\inf_{$0}$1", options: "mA"},
    ...
    // Graph theory - teoria de grafos
    {trigger: "cliq", replacement: "\\omega($0) $1", options: "mA"},
    {trigger: "estab", replacement: "\\alpha($0) $1", options: "mA"},
    {trigger: "marist", replacement: "\\textbackslash $0", options: "mA"},
    ...
    //Mis snippets
    {trigger: "bslh", replacement: "\\backslash", options: "mA"},
